...
export default async function SupervisorClientsPage() {
  ...
  if (!supabase) {
    ...
    try {
      ...
      console.error("Unexpected error loading clients:", e);
      clients = [];
      loadError = "Could not load clients from Supabase.";
    }
    ...
    try {
      ...
      if (error) {
        console.error("Error loading intern_profiles for client view:", error);
        interns = [];
      } else {
      ...
      console.error(
        "Unexpected error loading intern_profiles for client view:",
        e
      );
      interns = [];
    }
        ...
        <aside className="sidebar">
          ...
          <Link href="/supervisor">
            <button className="sidebar-link" type="button">
              ...
              <div className="sidebar-link-subtitle">Cohort</div>
            </button>
          </Link>
          ...
          <Link href="/supervisor/supervision">
            <button className="sidebar-link" type="button">
              ...
              <div className="sidebar-link-subtitle">Hours & sessions</div>
            </button>
          </Link>
          ...
          <Link href="/supervisor/pd">
            <button className="sidebar-link" type="button">
              <div className="sidebar-link-title">PD</div>
              <div className="sidebar-link-subtitle">Events & ecosystem</div>
            </button>
          </Link>
